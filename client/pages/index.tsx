...
const pageStates = {
  ...
  ERROR_POPUP: 'ERROR_POPUP', // displays error message popup
};
...
const Home = () => {
  ...
  const [showErrorPopup, setShowErrorPopup] = useState(false); // show error popup flag
    ...
    try {
      ...
      if (formData) {
        ...
        if (invalidProducts.length > 0) {
          ...
          // setPageState(pageStates.ERROR_POPUP);  
